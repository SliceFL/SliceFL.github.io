...
In this example, the first code snippet contains a Circle class
 <!--more-->
 with some basic operations. The error is in the constructor when calculating the perimeter (a multiplier of two is missing). 
